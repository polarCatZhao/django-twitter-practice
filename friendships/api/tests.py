...
class FriendshipApiTests(TestCase):
    ...
    def test_followers_pagination(self):
        ...
        for i in range(page_size * 2 + 3):
            follower = self.create_user(f'linghu_follower{i}')
        ...
        self._paginate_until_the_end(url, 3, friendships)
    ...
    def test_followings_pagination(self):
        ...
        friendships = []
        for i in range(page_size * 2 + 3):
            following = self.create_user(f'linghu_following{i}')
        ...
        # linghu has followed all his followings
        ...
        new_friends = [self.create_user(f'big_v{i}') for i in range(3)]
        new_friendships = []
    ...
    def _paginate_until_the_end(self, url, expect_pages, friendships):
        ...
        # friendships is in ascending order, results is in descending order
